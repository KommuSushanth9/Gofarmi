...
<body>
    <div class="options-container">
        <div class="option" onclick="selectOption('FARMER')">రైతు</div>
        <div class="option" onclick="selectOption('EMPLOYEE')">ఉద్యోగి</div>
        <div class="option" onclick="selectOption('EQUIPMENT LENDER')">సామగ్రి రుణదాత</div>
        <div class="option" onclick="selectOption('EQUIPMENT BORROWER')">సామగ్రి రుణగ్రహీత</div>
    </div>
