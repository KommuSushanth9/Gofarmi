...
<body>
    <div class="options-container">
        <div class="option" onclick="selectOption('FARMER')">किसान</div>
        <div class="option" onclick="selectOption('EMPLOYEE')">कर्मचारी</div>
        <div class="option" onclick="selectOption('EQUIPMENT LENDER')">उपकरण ऋणदाता</div>
        <div class="option" onclick="selectOption('EQUIPMENT BORROWER')">उपकरण उधारकर्ता</div>
    </div>
