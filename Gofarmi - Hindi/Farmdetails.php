    ...
    <body>
        ...
        <h2>फार्म विवरण प्रपत्र</h2>

        <form action="b_fd.php" method="post">
            <!-- Crop Name -->
            <label for="cropName">फसल का नाम:</label>
            <input type="text" id="cropName" name="cropName" required><br>

            <!-- Type of Work -->
            <label for="workType">काम के प्रकार:</label>
            <input type="text" id="workType" name="workType" required><br>

            <!-- Work Type (Paid or Free) -->
<label for="workCategory">कार्य श्रेणी:</label>
<select id="workCategory" name="workCategory" required>
    <option value="paid">भुगतान कार्य</option>
    <option value="free">मुफ्त काम</option>
</select><br>

            <!-- Phone Number -->
            <!-- Phone Number -->
<label for="phoneNumber">फ़ोन नंबर:</label>
<input type="text" id="phoneNumber" name="phoneNumber"  required>
            ...
            <!-- Payment Details -->
            <label for="paymentDetails">भुगतान विवरण:</label>
