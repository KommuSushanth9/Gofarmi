<?php
include('connectionfd.php'); // Include your database connection file
...
<body>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<tr>
                ...
                <td>
                    <a href='display_fd.php?action=delete&phoneNumber=$phoneNumber' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a>
